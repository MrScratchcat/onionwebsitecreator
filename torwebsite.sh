...
[Service]
Type=simple
ExecStart=/usr/local/bin/tor.sh

[Install]
WantedBy=default.target
" > onion.service

sudo cp onion.service /etc/systemd/system
sudo rm onion.service
sudo chmod +x /etc/systemd/system/onion.service

sudo echo "#!/bin/bash
sudo service nginx restart && sudo service tor restart" > tor.sh
sudo chmod +x tor.sh
sudo cp tor.sh /usr/local/bin
